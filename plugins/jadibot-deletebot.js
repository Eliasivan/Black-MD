...
const isCommand3 = /^(subs|listjadibots|subbots)$/i.test(command)  
...
handler.command = ['deletesesion', 'deletebot', 'deletesession', 'deletesession', 'stop', 'pausarblack', 'pausarbot', 'subs', 'lisgokublacksito', 'bots']
