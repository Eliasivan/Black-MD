...
const isCommand2 = /^(stop|pausarblack|pausarbot)$/i.test(command)   
...
await conn.reply(m.chat, `Adiós GokuBlacksito`, m, fake)
conn.ws.close()}
break
...
handler.command = ['deletesesion', 'deletebot', 'deletesession', 'deletesession', 'stop', 'pausargokublack', 'pausarbot', 'bots', 'listjadibots', 'subbots']
