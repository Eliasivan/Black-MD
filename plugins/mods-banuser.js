var handler = async (m, { conn, text, usedPrefix, command}) => {
  ...
  try {
    ...
    try {
      ...
      await conn.sendMessage(user, { text: '☺️ *Te banearon*\n\nContacta con el owner para saber más sobre tu situación.' })
      await conn.reply('59169739411@s.whatsapp.net', `🚩 El usuario *${nametag}* ha sido Baneado por *${nn}*.`, m, rcanal, );
