...
await m.reply(`${who == m.sender ? `Tienes *${user.money} Chocolates 🍫* en tu Cartera` : `El usuario @${who.split('@')[0]} tiene *${user.money} Chocolates 🍫* en su Cartera`}. `, null, { mentions: [who] })}
