...
author = author || 'no encontrado'
    ...
    const infoMessage = `*◉——⌈🔊 YOUTUBE-PLAY 🔊⌋——◉*\n ❏ 📌 *Titulo:* ${title} ❏ 📆 *Publicado:* ${ago} ❏ ⌚ *Duracion:* ${secondString(yt_play.duration.seconds)} ❏ 👀 *Vistas:* ${`${MilesNumber(views)}`} ❏ 👤 *Autor:* ${yt_play.author.name} ❏ ⏯️ *Canal:* ${yt_play.author.url} ❏ 🆔 *ID:* ${yt_play.videoId} ❏ 🪬 *Tipo:* ${yt_play.type} ❏ 🔗 *Link:* ${url}\n ❏ *_Enviando audio, aguarde un momento．．．_*`
