...
export default async function (m, conn = { user: {} }) {
    try {
        ...
        try {
            ...
            console.error(`Error al descargar imagen: ${e.message}`);
        }
        ...
        console.log(`╭────────────────────────────────···
│🌸  ${chalk.black(chalk.bgMagentaBright('%s'))}\n│⏰ㅤ${chalk.magentaBright(oraColombia)}\n│📑ㅤ${chalk.magentaBright('%s')}\n│📊ㅤ${chalk.magentaBright('%s [%s %sB]')}
│🗣ㅤ${chalk.white('%s')}\n│📃ㅤ${chalk.magentaBright('%s%s')}\n│🌐ㅤ${chalk.magentaBright(chatName)}\n│📝ㅤ${chalk.magentaBright('%s')}
╰───────────────────···
`.trim(),
